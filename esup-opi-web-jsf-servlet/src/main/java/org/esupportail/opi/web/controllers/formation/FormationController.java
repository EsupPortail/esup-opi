...
import org.esupportail.opi.web.beans.pojo.SummaryWishesPojo;
...
public class FormationController extends AbstractAccessController {
	...
	public String add() {
		...
		RegimeInscription regime = getRegimeIns().get(Utilitaires
				.getCodeRIIndividu(getCurrentInd().getIndividu(),
						getDomainService()));
