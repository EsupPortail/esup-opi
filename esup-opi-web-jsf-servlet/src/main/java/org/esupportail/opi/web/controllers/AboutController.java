...
public class AboutController extends AbstractContextAwareController {
	...
	/**
	 * Construit le select pour choisir la composante trier par etablissement.
	...
	public List<SelectItem> getMotClefItems() {
		...
		listS2[2] = s;
		group = new SelectItemGroup("Sciences Humaines et Sociales", null, false, listS2);
		listGroup.add(group);
		...
		s = new SelectItem("v", "Philosophie");
		listS2[1] = s;
		group = new SelectItemGroup("Sciences, Technologies, Sante", null, false, listS2);
		listGroup.add(group);
