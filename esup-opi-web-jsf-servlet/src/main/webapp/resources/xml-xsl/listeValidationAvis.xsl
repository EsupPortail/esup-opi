            ...
            <xsl:for-each select="value">
                <fo:block font-size="{$para-font-size-small}" font-family="{$para-font-family}">
                    <fo:table table-layout="fixed" width="100%"
                        ...
                        <xsl:if test="key/code-type-convocation = 'LC'">
                            <fo:table-column column-width="proportional-column-width(0.5)"/>
                        </xsl:if>
                        <fo:table-column column-width="proportional-column-width(0.5)"/>
                        ...
                        <fo:table-header color="black" border="1pt solid black">
                            <fo:table-row>
                                <fo:table-cell padding="2pt" border="0pt solid black"
                                    ...
                                    <fo:block font-size="{$para-font-size-medium}" font-family="{$para-font-family}"
                                              text-indent="0cm" text-align="start" font-weight="bold">
                                        Code Etape :
                        ...
                        <fo:table-body border-left="1pt solid black"
                            ...
                            <xsl:for-each select="value">
                                <fo:table-row border="1">
                                    ...
                                    <xsl:if test="ind-voeux-pojo/avis-en-service/result/code-type-convocation = 'LC'">
                                        <fo:table-cell padding="2pt" border-bottom="0.5pt solid black"
                                                       border-top="0.5pt solid black">
                                            <fo:block>
                                                <xsl:value-of select="ind-voeux-pojo/avis-en-service/rang"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </xsl:if>
                                    <fo:table-cell padding="2pt" border-bottom="0.5pt solid black"
                                    ...
                                    <fo:table-cell padding="2pt" border-bottom="0.5pt solid black"
                                        ...
                                        <fo:block>
                                            <xsl:value-of
                                                    select="ind-voeux-pojo/avis-en-service/motivation-avis/libelle"/>
