				...
				<t:div styleClass="blockTable" style="width:60%;">
					...
					<t:div id="div_subSection" styleClass="div_subSection">
						<t:div style="text-align:center;">
								<e:text value="#{msgs['EXCEPTION.APOGEE.TITLE']}" styleClass="form-field-label" 
										style="font-size:18px;"/>
						</t:div>
						<t:div style="text-align:center;">
							<e:text value="#{msgs['EXCEPTION.APOGEE.EXPLAIN.1']}" style="font-size:22px;" />
							<e:text value="#{msgs['EXCEPTION.APOGEE.EXPLAIN.2']}" style="font-size:22px;" />
						</t:div>
						<t:htmlTag value="br"/>
						<t:div style="text-align:center;">
