...
<t:div id="blockCandidatureWithVoeu" styleClass="blockForm"
	...
	<t:div style="width:100%;">
		<e:panelGrid columns="2" columnClasses="col1UnDemi,col2UnDemi"
			...
			<t:panelGroup>
				<e:text value="#{msgs['INDIVIDU.YOUR.CANDIDATURES']}"
			...
			<t:panelGroup>
				...
				<e:commandButton value="#{msgs['_.BUTTON.DOWNLOAD.DOSSIER']}"
					immediate="true" action="#{accueilController.validatePrintDossier}" />
								...
								<f:facet name="popup">
									<h:panelGroup>
										<h:panelGrid columns="1">
											...
											<t:panelGroup styleClass="contenuAide">
												<e:ul>
													<e:li>
													...
													<e:li>
														<e:text value="#{msgs['STATE.CONFIRM']}"
															styleClass="span-text-small" />
														<e:text value=" : " styleClass="span-text-small" />
														<e:text value="#{msgs['STATE.CONFIRM.COMMENT']}"
															styleClass="span-text-small" />
													</e:li>
													<e:li>
														<e:text value="#{msgs['STATE.DESIST']}"
															styleClass="span-text-small" />
														<e:text value=" : " styleClass="span-text-small" />
														<e:text value="#{msgs['STATE.DESIST.COMMENT']}"
															styleClass="span-text-small" />
													</e:li>
												</e:ul>
											</t:panelGroup>
...
<t:div id="blockCandidatureWithoutVoeu"
	...
	<t:div styleClass="blockTable" style="text-align:center;">
		...
		<t:outputText value="#{msgs['INDIVIDU.INFO.STATE_INCOMPLET.FC']}" 
			rendered="#{!sessionController.currentInd.etat.canDoChoiceEtape &&
						sessionController.currentInd.regimeInscription.displayInfoFC}"
