...
FCKConfig.ToolbarSets["Scholar"] = [
                                    ...
                                    ['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
                                    ['Link','Unlink','Anchor'],
                                    ['FontSize','TextColor','BGColor','-','Table','Rule','PageBreak','UniversalKey'],
                                    '/',
                                    ['FitWindow','-','About']
                                     ];

FCKConfig.ToolbarSets["Comment"] = [
                                    ['Cut','Copy','Paste','PasteText','PasteWord','OrderedList','UnorderedList','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','Outdent','Indent'],
                                    '/',
                                    ['Bold','Italic','Underline','-','TextColor','FontFormat']	
                                     ];

FCKConfig.ToolbarSets["MailContent"] = [
