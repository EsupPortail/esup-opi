				...
				<fo:table-body border-left="1pt solid black" border-right="1pt solid black"
					...
					<xsl:for-each select="liste-ind-prepa">
						<fo:table-row border="1" >
							...
							<fo:table-cell number-columns-spanned="6" padding="0pt" border-bottom="0.5pt solid black" border-top="0.5pt solid black">
								<fo:block>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="2pt" border="0pt solid black">
														<fo:block>
															...
															<xsl:value-of select="avis-en-service/commentaire"/>														</fo:block>
													</fo:table-cell>
												</fo:table-row>
											</xsl:for-each>
										</fo:table-body>
						...
						<xsl:if test="position() = last()">
							<fo:table-row>
								<fo:table-cell padding="2pt" border-bottom="0.5pt solid black"
									border-top="0.5pt solid black" number-columns-spanned="11"
									text-align="right" font-weight="bold">
									<fo:block>
										Nombre de dossiers total : <xsl:value-of select="position()" />
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</xsl:if>	
