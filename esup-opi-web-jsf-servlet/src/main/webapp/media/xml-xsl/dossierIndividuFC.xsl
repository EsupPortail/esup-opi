...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="situation">
		<fo:block line-height="110%" hyphenate="false" language="fr"
			...
			text-align="center">
			<fo:inline color="#333333" font-weight="bold"
				font-family="{$para-font-family}">SITUATION ACTUELLE </fo:inline>
		</fo:block>
		<xsl:choose>
	...
	<xsl:template name="informationCompl">
		...
		<fo:block line-height="110%" hyphenate="false" language="fr"
			...
			<fo:inline color="#333333" font-weight="bold"
				...
				A COMPLÉTER DIRECTEMENT SUR CE DOCUMENT</fo:inline>
		</fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="14pt"
                   font-family="{$para-font-family-small}" font-weight="bold">
        ...
        <fo:block line-height="110%" hyphenate="false"
                 ...
                 <fo:block>
                    <fo:block line-height="110%" hyphenate="false"
                       ...
                       MODALITES ENVISAGÉES DE FINANCEMENT DE VOTRE FORMATION</fo:inline>
                    </fo:block>
                    <fo:block line-height="110%" hyphenate="false"
                          ...
                          <fo:table-row keep-together.within-column="always">
                             <fo:table-cell padding-left="0.123cm" padding-right="0.123cm" padding-top="0cm"
                                ...
                                <fo:block line-height="110%" hyphenate="false"
                                           ...
                                           font-family="{$para-font-family-small}"
                                           text-align="center"
                                           font-weight="bold">Salariés :</fo:block>
                             </fo:table-cell>
                             <fo:table-cell padding-left="0.123cm" padding-right="0.123cm" padding-top="0cm"
                                             padding-bottom="0cm"  border-left="0.018cm solid #000000"
                                             border-right="none" border-top="0.035cm solid #000000"
                                 ...
                                 <fo:block line-height="110%" hyphenate="false"
                                           ...
                                           font-family="{$para-font-family-small}"
                                           text-align="center"
                                           font-weight="bold">Demandeurs d'emploi :</fo:block>
                             </fo:table-cell>
                             <fo:table-cell padding-left="0.123cm" padding-right="0.123cm" padding-top="0cm"
                                             padding-bottom="0cm" border-left="0.018cm solid #000000"
                                ...
                                <fo:block line-height="110%" hyphenate="false"
                                           ...
                                           text-align="center"
                                           font-weight="bold">Autre :</fo:block>
                             </fo:table-cell>
                          </fo:table-row>
                          <fo:table-row keep-together.within-column="always">
        ...
        <fo:block line-height="110%" hyphenate="false"
           ...
           <fo:inline font-family="{$para-font-family}"> (noms précis des organismes sollicités, date des demandes et réponses obtenues)</fo:inline>
           <fo:inline color="#000080" font-family="{$para-font-family}">: <fo:leader leader-pattern="dots"/>
           </fo:inline>
        </fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
        ...
        <fo:block line-height="110%" hyphenate="false"
                   ...
                   joindre une photocopie des pièces à votre dossier de candidature.</fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}">
           <fo:inline font-weight="bold" font-family="{$para-font-family}">
           Veuillez nous tenir régulièrement informés de l'état d'avancement de vos démarches</fo:inline>
        ...
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family}">
                   Pour plus d'information sur les modalités de financement de votre formation : </fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt" font-family="{$para-font-family-small}">
           <fo:inline color="#0000ff">
              <fo:inline font-family="{$para-font-family}">http://sfc.univ-rennes1.fr/accueil/financement.html</fo:inline>
            </fo:inline>
        ...
        <fo:block line-height="110%" hyphenate="false"
                   ...
                   font-weight="bold">MODALITES D'INFORMATION SUR LA FORMATION</fo:block>
        <fo:block line-height="110%" hyphenate="false"
         ...
         <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}"
                   font-weight="bold">Par quels moyens avez-vous eu connaissance de cette formation ? </fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}" margin-left="0cm" margin-right="0cm"
                   text-indent="0.212cm">
           <fo:external-graphic src="url('square.JPG')" /> votre employeur</fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}" margin-left="0cm"
                   margin-right="0cm" text-indent="0.212cm">
           <fo:external-graphic src="url('square.JPG')" /> un(e) ancien(ne) étudiant(e) / stagiaire de l'Université</fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}" margin-left="0cm"
                   margin-right="0cm" text-indent="0.212cm">
           <fo:external-graphic src="url('square.JPG')" /> un organisme conseil <fo:inline font-size="9pt">(Pôle emploi, OPACIF, cabinet de recrutement, centre de bilan de compétence...)</fo:inline>
        </fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}" margin-left="0cm" margin-right="0cm"
                   text-indent="0.212cm">
           <fo:external-graphic src="url('square.JPG')" /> affiche / plaquette / catalogue</fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}" margin-left="0cm"
                   margin-right="0cm"
                   text-indent="0.212cm">
           <fo:external-graphic src="url('square.JPG')" /> rencontre sur un salon / portes ouvertes</fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}" margin-left="0cm" margin-right="0cm"
                   text-indent="0.212cm">
           <fo:external-graphic src="url('square.JPG')" /> site Internet <fo:inline font-size="9pt">(précisez lequel :
        ...
        <fo:block line-height="110%" hyphenate="false"
           ...
           <fo:external-graphic src="url('square.JPG')" /> presse écrite <fo:inline font-size="9pt">(précisez le journal :
			______________________________________________________________</fo:inline>
        </fo:block>
        <fo:block line-height="110%" hyphenate="false"
                   language="fr" country="FR" font-size="11pt"
                   font-family="{$para-font-family-small}" margin-left="0cm"
                   margin-right="0cm" text-indent="0.212cm">
           <fo:external-graphic src="url('square.JPG')" /> autre moyen <fo:inline font-size="9pt">(précisez : 
			______________________________________________________________________</fo:inline>
        </fo:block>
	</xsl:template>
